                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Pengajuan Ditolak</h2>
                                <ol class="breadcrumb">
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                            ...
                                            $jabatan = Modules\Pengajuan\Entities\KeteranganJabatan::select()
                                                ...
                                                ->first();
                                            @endphp
                                            @if ($status->status==2 && $jabatan->jabatan ==3|| 
                                                  $status->status==2 && $jabatan->jabatan == 4 && $divisi->divisi==1 ||
