...
@section('content')
    @php
        ...
        foreach ($projects as $project) {
            ...
            if (($histori->status == 4 && $histori->jabatan == 7) || ($histori->status == 1 && $histori->jabatan == 4) || ($histori->status == 1 && $histori->jabatan == 3) || ($histori->status == 1 && $histori->jabatan == 2) || ($histori->status == 1 && $histori->jabatan == 1)) {
                $proses++;
            }
        }
                            ...
                            <div class="card-body justify-content-center">
                                ...
                                <div class="transaction-item">
                                    <div class="d-flex">
                                        <div class="avatar bg-light-success ">
                                            <div class="avatar-content">
                                                <i data-feather="circle" class="avatar-icon font-medium-3"></i>
                                            </div>
                                        </div>
                                        <div class="transaction-percentage">
                                            <h6 class="transaction-title">
